...
(16,'Can add django job',6,'add_djangojob'),
(17,'Can change django job',6,'change_djangojob'),
(18,'Can delete django job',6,'delete_djangojob'),
(19,'Can add django job execution',7,'add_djangojobexecution'),
(20,'Can change django job execution',7,'change_djangojobexecution'),
(21,'Can delete django job execution',7,'delete_djangojobexecution'),
(22,'Can add system configuration',8,'add_config'),
(23,'Can change system configuration',8,'change_config'),
(24,'Can delete system configuration',8,'delete_config'),
(25,'Can add slow query statistics',9,'add_slowquery'),
(26,'Can change slow query statistics',9,'change_slowquery'),
(27,'Can delete slow query statistics',9,'delete_slowquery'),
(28,'Can add slow query details',10,'add_slowqueryhistory'),
(29,'Can change slow query details',10,'change_slowqueryhistory'),
(30,'Can delete slow query details',10,'delete_slowqueryhistory'),
(31,'Can add user management',11,'add_users'),
(32,'Can change user management',11,'change_users'),
(33,'Can delete user management',11,'delete_users'),
(34,'Can add Alibaba Cloud credential info',12,'add_aliyunaccesskey'),
(35,'Can change Alibaba Cloud credential info',12,'change_aliyunaccesskey'),
(36,'Can delete Alibaba Cloud credential info',12,'delete_aliyunaccesskey'),
(37,'Can add Alibaba Cloud RDS config',13,'add_aliyunrdsconfig'),
(38,'Can change Alibaba Cloud RDS config',13,'change_aliyunrdsconfig'),
(39,'Can delete Alibaba Cloud RDS config',13,'delete_aliyunrdsconfig'),
(40,'Can add data masking column config',14,'add_datamaskingcolumns'),
(41,'Can change data masking column config',14,'change_datamaskingcolumns'),
(42,'Can delete data masking column config',14,'delete_datamaskingcolumns'),
(43,'Can add data masking rule config',15,'add_datamaskingrules'),
(44,'Can change data masking rule config',15,'change_datamaskingrules'),
(45,'Can delete data masking rule config',15,'delete_datamaskingrules'),
(46,'Can add group configuration',16,'add_group'),
(47,'Can change group configuration',16,'change_group'),
(48,'Can delete group configuration',16,'delete_group'),
(49,'Can add group relation configuration',17,'add_grouprelations'),
(50,'Can change group relation configuration',17,'change_grouprelations'),
(51,'Can delete group relation configuration',17,'delete_grouprelations'),
(52,'Can add master connection config',18,'add_master_config'),
(53,'Can change master connection config',18,'change_master_config'),
(54,'Can delete master connection config',18,'delete_master_config'),
(55,'Can add SQL query logs',19,'add_querylog'),
(56,'Can change SQL query logs',19,'change_querylog'),
(57,'Can delete SQL query logs',19,'delete_querylog'),
(58,'Can add query privilege records',20,'add_queryprivileges'),
(59,'Can change query privilege records',20,'change_queryprivileges'),
(60,'Can delete query privilege records',20,'delete_queryprivileges'),
(61,'Can add query privilege application records',21,'add_queryprivilegesapply'),
(62,'Can change query privilege application records',21,'change_queryprivilegesapply'),
(63,'Can delete query privilege application records',21,'delete_queryprivilegesapply'),
(64,'Can add query slave config',22,'add_slave_config'),
(65,'Can change query slave config',22,'change_slave_config'),
(66,'Can delete query slave config',22,'delete_slave_config'),
(67,'Can add SQL workflow management',23,'add_workflow'),
(68,'Can change SQL workflow management',23,'change_workflow'),
(69,'Can delete SQL workflow management',23,'delete_workflow'),
(70,'Can add workflow list',24,'add_workflowaudit'),
(71,'Can change workflow list',24,'change_workflowaudit'),
(72,'Can delete workflow list',24,'delete_workflowaudit'),
(73,'Can add workflow audit detail table',25,'add_workflowauditdetail'),
(74,'Can change workflow audit detail table',25,'change_workflowauditdetail'),
(75,'Can delete workflow audit detail table',25,'delete_workflowauditdetail'),
(76,'Can add approval workflow configuration',26,'add_workflowauditsetting'),
(77,'Can change approval workflow configuration',26,'change_workflowauditsetting'),
(78,'Can delete approval workflow configuration',26,'delete_workflowauditsetting');
