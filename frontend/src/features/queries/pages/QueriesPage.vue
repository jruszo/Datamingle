...
import QueryMetadataExplorer from '@/features/queries/components/QueryMetadataExplorer.vue'
...
} from '@/features/queries/components/query-metadata-explorer'
...
async function openExportRequest() {
  ...
  window.sessionStorage.setItem(
    ...
    JSON.stringify({
      ...
      dbName: form.dbName,
      schemaName: needsSchemaSelection.value ? form.schemaName : '',
